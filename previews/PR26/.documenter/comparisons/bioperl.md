...
- Consult the [Running External Programs](https://docs.julialang.org/en/v1/manual/running-external-programs/) section in the manual for running Perl scripts or other programs from Julia
